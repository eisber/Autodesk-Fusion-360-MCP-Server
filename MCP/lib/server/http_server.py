    ...
    class MCPHandler(BaseHTTPRequestHandler):
        ...
        def send_task_and_wait(self, task_tuple, success_message, timeout=10.0):
            ...
            if result.get("success"):
                ...
                self.send_json(
                    {"success": False, "error": result.get("error", "Unknown error")}, status=500
                )
        ...
        def do_GET(self):
            ...
            try:
                ...
                if handler:
                    ...
                    _log_debug("  GET completed successfully")
                else:
                    _log_debug("  404 Not Found")
        ...
        def do_POST(self):
            ...
            try:
                ...
                if handler:
                    ...
                    _log_debug("  POST completed successfully")
                else:
                    _log_debug("  404 Not Found")
                    self.send_error(404, "Not Found")
            except Exception as e:
