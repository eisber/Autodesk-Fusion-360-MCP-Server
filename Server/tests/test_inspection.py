...
from src.tools.inspection import get_adsk_class_info, inspect_adsk_api


class TestInspectAdskApi:
    """Tests for inspect_adsk_api function."""

    @patch("src.tools.inspection._execute_script_sync")
...
class TestGetAdskClassInfo:
    ...
    def test_get_class_info_invalid_path(self, mock_execute):
        ...
        mock_execute.return_value = {
            "success": True,
            "return_value": {"error": "Path not found: adsk.fusion.NotAClass"},
        }
